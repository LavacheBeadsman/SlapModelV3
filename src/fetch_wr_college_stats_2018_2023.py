"""
Fetch WR College Stats from CFBD API for 2018 and 2023 seasons.

These seasons are needed for:
- 2019 draft class (2018 final season)
- 2024 draft class (2023 final season)
"""
...
def main():
    print("=" * 90)
    print("FETCHING WR COLLEGE STATS FROM CFBD API (2018 & 2023)")
    print("=" * 90)
    ...
    # Filter to WRs who need 2018 and 2023 seasons (2019 and 2024 draft classes)
    target_draft_years = [2019, 2024]
    target_wrs = wr_backtest[wr_backtest['draft_year'].isin(target_draft_years)].copy()
    print(f"WRs drafted 2019 and 2024 (needing 2018 and 2023 data): {len(target_wrs)}")
    ...
    # Save results
    output_file = 'data/wr_college_stats_2018_2023.csv'
